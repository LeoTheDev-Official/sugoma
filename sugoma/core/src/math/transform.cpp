...
{
	glm::vec3 Transform::forward() const { return glm::vec3(rotation() * glm::vec4(0, 0, 1, 1)); }
	glm::vec3 Transform::right() const { return glm::vec3(rotation() * glm::vec4(1, 0, 0, 1)); }
	glm::vec3 Transform::up() const { return glm::vec3(rotation() * glm::vec4(0, 1, 0, 1)); }
